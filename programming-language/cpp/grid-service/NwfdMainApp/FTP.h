...
public :
    ...
    //下载文件(支持断点下载)
    FTP_API Get2(const std::string &strRemoteFile, const std::string &strLocalFile, const int pos);
...
private:
    ...
    //以ab+方式打开本地文件
    FILE *createLocalFile2(const std::string & strLocalFile);
    ...
    //下载文件(支持断点下载)
    FTP_API downLoad2(const std::string &strRemoteFile, const std::string& strLocalFile, const int pos = 0, const unsigned int length = 0);
