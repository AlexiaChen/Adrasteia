...
public:
	...
	static QString GetFileNameWildCard(QString strSrcFileName, int nYear, int nMonth, int nDay, QString strType, int nTimeRange);
	
    static bool Exists(QString strFile);
	static bool Rename(QString strOldFileName, QString strNewFileName);
	static bool ParseFileName(QString strFileName, ST_FILE_FORMAT stFileNameFormat, int &nYear, int &nMonth, int &nDay, int &nHour);
	static bool ParseFileName(QString strFileName, ST_FILE_FORMAT stFileNameFormat, int &nYear, int &nMonth, int &nDay, int &nHour, int &nForecastTime);
	static bool ParseFileName(QString strFileName, ST_FILE_FORMAT stFileNameFormat, int &nYear, int &nMonth, int &nDay, int &nHour, int &nForecastTime, int &nTimeRange);
