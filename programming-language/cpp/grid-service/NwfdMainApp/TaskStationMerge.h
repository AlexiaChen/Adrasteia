...
*
*************************************************************************/
#ifndef TASK_STATION_MERGE_H
#define TASK_STATION_MERGE_H
...
/* 描 述：                                                              */
/************************************************************************/
class TaskStationMerge : public TaskBase
{
	Q_OBJECT
...
private:
	...
	int  GetStationData(char * szStationNo, QString strSaveRule, int nYear, int nMonth, int nDay, int nHour, int nMinute, int nSecond, float * &fData, int &nRow, int &nCol);
